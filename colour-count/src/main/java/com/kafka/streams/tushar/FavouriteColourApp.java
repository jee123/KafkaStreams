...
/**
 * Created by tjee on 11/15/17.
 */
public class FavouriteColourApp {
    private static final Logger log = LoggerFactory.getLogger(FavouriteColourApp.class);
    ...
    public static void main(String[] args) {
        ...
        //11 - listing topology
        log.info("TOPOLOGY like --->>> " + streams.toString());


        //12 - Adding shutdown hook
